...
public class MainActivity extends AppCompatActivity {
    ListView lv;
    EditText et_search;
    Button btn_search, btn_like;
    ImageButton ib_back1;
    //    ArrayList<String> url_list = new ArrayList<>();
//    List<String> url_list = Collections.synchronizedList(new ArrayList<>());
...
//        });
        ...
        sendRequestWithOkHttp_search("林宥嘉");
...
//                            Log.d("TTT", "已获取" + position + "URL" + url1);
